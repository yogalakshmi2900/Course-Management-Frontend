...
import { SIDEBAR } from '../../common/facultysidebar';
import URL from '../../common/api';

class FacultySidebar extends React.Component {
  // constructor(props) {
  //   super(props);
  // }
  menuSelection(event) {
...
const FacultySidebarComponent = connect(mapStateToProps,mapDispatchToProps)(FacultySidebar);

export default FacultySidebarComponent;
